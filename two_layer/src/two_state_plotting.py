...
with open('cumu_extinct_2layer_main_delta_11_13.npy', 'rb') as f:
...
with open('extinct_mom_b_2layer_main_delta_11_20.npy', 'rb') as f:
    extinct_mom_b_delta = np.load(f)

with open('extinct_mom_b_2layer_main_poisson_11_20.npy', 'rb') as f:
    extinct_mom_b_poisson = np.load(f)


with open('extinct_mom_b_2layer_main_geometric_11_20.npy', 'rb') as f:
    extinct_mom_b_geometric = np.load(f)
...
plt.plot(t_vec, extinct_mom_b_delta, label = 'Cumulative probability of extinction - MOM basals (Delta intitial conditions)')
plt.plot(t_vec, extinct_mom_b_geometric, label = 'Cumulative probability of extinction - MOM basals (Geometric approx, Poisson Initial conditions)')
plt.legend()
...
plt.xlabel('Time')
plt.title('2 Layer system')
plt.savefig("extinction_prob_poisson_11-20_geometric.pdf", format = 'pdf')
# plt.show()
plt.close()
